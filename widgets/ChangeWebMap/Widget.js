    ...
    function (declare,
        ...
        return declare([BaseWidget, _WidgetsInTemplateMixin], {
            ...
            postCreate: function () {
                ...
                this.changemapInicio("3f78df3e90414b7ca846a0afb99f1fb6","volcan");
            ...
            promptUserToZoomToItem: function (item) {
                ...
                var dlg = new Message({
                    message: "Desea acercarse al nuevo mapa?",
                    type: 'question',
                    buttons: [{
                        label: "No",
            ...
            urlParametros: function (name, url) {
            ...
            changemapInicio: function (id, name) {

                var urlinicio = this.urlParametros(name);
                console.log("parametro....."+ urlinicio);

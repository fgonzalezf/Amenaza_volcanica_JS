...
define([
  ...
  function (
    ...
    SimpleRenderer, jsonUtil, Draw, PopupTemplate, esriRequest, Color, Deferred, ProgressBar, lang, on, html, array, all, date, locale, Select,
          ...
          if (this.wManager) {
            ...
            if(widgetCfg){
              ...
              if(attWidget){
                ...
                attWidget.onClickRefreshButton();
              }
            }
          }
        }
...
/*if we have a sum field then sum the fields values*/
      ...
      _drawResults: function (layerIndex, results, currentLayer, closeOnComplete) {
        ...
        console.info("List item Length: " + this.list.items.length, "CurrentFeatures Length: " + this.currentFeatures.length);
